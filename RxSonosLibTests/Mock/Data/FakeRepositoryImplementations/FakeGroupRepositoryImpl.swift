...
class FakeGroupRepositoryImpl: GroupRepository {
    ...
    func allGroups() throws -> [Group] {
        ...
        groups.append(Group(id: "1", master: livingRoom, slaves: []))
        ...
        groups.append(Group(id: "2", master: bathroomRoom, slaves: []))
        ...
        groups.append(Group(id: "3", master: bedRoomLeft, slaves: []))
        ...
        groups.append(Group(id: "4", master: bedRoomRight, slaves: []))
        ...
        groups.append(Group(id: "5", master: kitchenRoom, slaves: []))
